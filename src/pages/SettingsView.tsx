    ...
    >
      ...
      <div className="flex gap-6">
            ...
            {tabs.map((tab) => (
              <li key={tab.id}>
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors ${activeTab === tab.id ? "bg-white text-heading shadow-sm border border-border" : "text-slate-500 hover:text-slate-700 hover:bg-white/50"}`}
                >
                  <span
                    className={
        ...
        <div className="flex-1 bg-white rounded-xl border border-border p-6">
          {activeTab === "general" && (
            <div className="space-y-5">
              ...
              <div>
                ...
                <select className="w-full px-3 py-2.5 text-sm border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/30 bg-white">
                  <option>Africa/Lagos (WAT, UTC+1)</option>
                  <option>Africa/Accra (GMT, UTC+0)</option>
                  <option>Africa/Nairobi (EAT, UTC+3)</option>
                </select>
              </div>
              <button className="px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-primary to-accent hover:from-primary-dark hover:to-accent rounded-lg transition-colors">
                Save Changes
              </button>
            </div>
          )}
          ...
          {activeTab === "branding" && (
            <div className="space-y-5">
              <h2 className="text-lg font-semibold text-heading">Branding</h2>
              <div>
                <label className="block text-xs font-medium text-slate-600 mb-1.5">
                  Logo
                </label>
